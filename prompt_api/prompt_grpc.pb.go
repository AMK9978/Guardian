...
const (
	PromptService_SendPrompt_FullMethodName = "/prompt.PromptService/SendPrompt"
)
...
func (c *promptServiceClient) SendPrompt(ctx context.Context, in *SendPromptRequest, opts ...grpc.CallOption) (*SendPromptResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendPromptResponse)
	err := c.cc.Invoke(ctx, PromptService_SendPrompt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPromptServiceServer) SendPrompt(context.Context, *SendPromptRequest) (*SendPromptResponse, error) {
...
func _PromptService_SendPrompt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PromptService_SendPrompt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PromptServiceServer).SendPrompt(ctx, req.(*SendPromptRequest))
	}
